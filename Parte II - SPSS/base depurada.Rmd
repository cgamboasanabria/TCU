...
```{r}
pos<-which(rowSums(base[, c(99, 101, 103)]==8)>1)
base$SEAN21_B1[c(7, 35, 146, 267)]<-0
base$SEAN21_C1[pos]<-0
...
table(base$P25)
base$P25<-recode(base$P25, `1`=30, `3`=31, `5`=32, `7`=33, `9`=34, `13`=35, `14`=5, `17`=36, `19`=37, `21`=38, `22`=9, `25`=11, `26`=12, `28`=13, `33`=17, `35`=39, `37`=40, `38`=19, `42`=21, `44`=22, `49`=42, `50`=24, `52`=25, `56`=26, `64`=43)
