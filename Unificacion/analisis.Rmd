---
title: "Instrumento aplicado a Estudiantes - Segundo avance"
...
library(dplyr)
library(xtable)
load("J:/Academico/Proyectos/GitHub/TCU/Unificacion/Estudiantes.RData")
```
...
\captionsetup[table]{labelformat=empty}
`r xtable::xtable(n, digits=1, caption='Pregunta 34: ¿Actualmente la EAN_UCR utiliza estrategias para favorecer la vivencia de los valores que sustenta ¿Tiene conocimiento de dichas estrategias?')`     
